...
wire            rg_fifo_chk_en;
wire            rg_frame_mode;
wire [3:0]      rg_multi_frame_num;
wire [7:0]      rg_setup_time;
reg  [4:0]      rg_int_clr;
...
wire [15:0]     CHIP_INFO;
wire [15:0]     CRGU_CTRL;
wire [15:0]     PIXEL_SIZE;
wire [15:0]     FIFO_THRESHOLD;
wire [15:0]     FIFO_USED;
wire [15:0]     ADC_CFG;
wire [15:0]     CTRL_REG;
wire [15:0]     INT_CLEAR;
...
wire [15:0]     PMU_CFG1;
wire [15:0]     PAD_CTRL;
wire [15:0]     ISP_PATTERN_CFG;
wire [15:0]     ISP_DPC_CFG;
wire            chip_info_wr;
wire            chip_info_rd;
wire            crgu_ctrl_wr;
wire            crgu_ctrl_rd;
...
assign chip_info_wr = (paddr == 16'h0000 + 8'h00) & reg_wr;
assign chip_info_rd = (paddr == 16'h0000 + 8'h00) & reg_rd;
assign crgu_ctrl_wr = (paddr == 16'h0000 + 8'h02) & reg_wr;
assign crgu_ctrl_rd = (paddr == 16'h0000 + 8'h02) & reg_rd;
assign pixel_size_wr = (paddr == 16'h0000 + 8'h04) & reg_wr;
assign pixel_size_rd = (paddr == 16'h0000 + 8'h04) & reg_rd;
assign fifo_threshold_wr = (paddr == 16'h0000 + 8'h06) & reg_wr;
assign fifo_threshold_rd = (paddr == 16'h0000 + 8'h06) & reg_rd;
assign fifo_used_wr = (paddr == 16'h0000 + 8'h08) & reg_wr;
assign fifo_used_rd = (paddr == 16'h0000 + 8'h08) & reg_rd;
assign adc_cfg_wr = (paddr == 16'h0000 + 8'h0a) & reg_wr;
assign adc_cfg_rd = (paddr == 16'h0000 + 8'h0a) & reg_rd;
assign ctrl_reg_wr = (paddr == 16'h0000 + 8'h0c) & reg_wr;
assign ctrl_reg_rd = (paddr == 16'h0000 + 8'h0c) & reg_rd;
assign int_clear_wr = (paddr == 16'h0000 + 8'h0e) & reg_wr;
assign int_clear_rd = (paddr == 16'h0000 + 8'h0e) & reg_rd;
assign int_status_wr = (paddr == 16'h0000 + 8'h10) & reg_wr;
assign int_status_rd = (paddr == 16'h0000 + 8'h10) & reg_rd;
assign pmu_cfg0_wr = (paddr == 16'h0000 + 8'h12) & reg_wr;
assign pmu_cfg0_rd = (paddr == 16'h0000 + 8'h12) & reg_rd;
assign pmu_cfg1_wr = (paddr == 16'h0000 + 8'h14) & reg_wr;
assign pmu_cfg1_rd = (paddr == 16'h0000 + 8'h14) & reg_rd;
assign pad_ctrl_wr = (paddr == 16'h0000 + 8'h16) & reg_wr;
assign pad_ctrl_rd = (paddr == 16'h0000 + 8'h16) & reg_rd;
assign isp_pattern_cfg_wr = (paddr == 16'h0000 + 8'h18) & reg_wr;
assign isp_pattern_cfg_rd = (paddr == 16'h0000 + 8'h18) & reg_rd;
assign isp_dpc_cfg_wr = (paddr == 16'h0000 + 8'h20) & reg_wr;
assign isp_dpc_cfg_rd = (paddr == 16'h0000 + 8'h20) & reg_rd;
...
always@(*) begin
    case(paddr)
        16'h0000 + 8'h00 : prdata = CHIP_INFO ;
        16'h0000 + 8'h02 : prdata = CRGU_CTRL ;
        16'h0000 + 8'h04 : prdata = PIXEL_SIZE;
        16'h0000 + 8'h06 : prdata = FIFO_THRESHOLD;
        16'h0000 + 8'h08 : prdata = FIFO_USED ;
        16'h0000 + 8'h0a : prdata = ADC_CFG   ;
        16'h0000 + 8'h0c : prdata = CTRL_REG  ;
        16'h0000 + 8'h0e : prdata = INT_CLEAR ;
        16'h0000 + 8'h10 : prdata = INT_STATUS;
        16'h0000 + 8'h12 : prdata = PMU_CFG0  ;
        16'h0000 + 8'h14 : prdata = PMU_CFG1  ;
        16'h0000 + 8'h16 : prdata = PAD_CTRL  ;
        16'h0000 + 8'h18 : prdata = ISP_PATTERN_CFG;
        16'h0000 + 8'h20 : prdata = ISP_DPC_CFG;
